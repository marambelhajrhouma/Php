...
<body>
    ...
    <div class="container-fluid bg-secondary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 300px">
            <h1 class="font-weight-semi-bold text-uppercase mb-3">LOGIN NOW</h1>
            <div class="d-inline-flex">
                <p class="m-0"><a href="">Welcome to the world of fashion</a></p>
    ...
    <div class="text-center mb-4">
        ...
        <form action="login_process.php" method="post" novalidate="novalidate">
    ...
    if (isset($_GET['error'])) {
        ...
        if ($errorCode == 1) {
            $errorMessage = "Incorrect password. Please enter a correct password.";
        } elseif ($errorCode == 2) {
            $errorMessage = "Email or password not provided. Please enter both email and password.";
        } elseif ($errorCode == 3) {
    ...
    ?>
    <div class="d-inline-flex">
                <p class="m-0">Don't have an account? You can <a href="register_form.php">Register Now</a></p>
